...
namespace ColorMatchingSystemAPP
{
    public partial class primaryForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            List<string> colorTypes = colorManager.ListColorTypes();
            Dictionary<string, string> unitsOfMeasurement = colorManager.ListUnitsOfMeasurement();

            colorTypeDropDown.DataSource = colorTypes;
        ...
        private void BindDataGrid()
        {
            ...
            if (colorType.Contains("Discharge"))
            {
                ...
                dischargeDataGrid.Visible = true;
                ...
                dischargeDataGrid.Visible = false;
            ...
            if (customMode)
            {
                ...
                string selectedColorType = colorTypeDropDown.SelectedItem != null ? colorTypeDropDown.SelectedItem.ToString() : "Water Base";
